...
In the \(\Csmall\) \(\mathbf{Q5E2}\) successor inventory, the branch has no remaining
...
obligation in the \(\Csmall\) \(\mathbf{Q5E2}\) successor inventory is either
...
\(\Csmall\) \(\mathbf{Q5E2}\) successor inventory.
\end{proof}
...
The \(\mathbf{Q5E2}\) successor inventory in \(\Csmall\) is exhausted by the
finite post-window closures for the four pairs \((109,11)\), \((229,23)\),
\((349,7)\), and \((409,41)\), together with their parametric post-window
certificates.
