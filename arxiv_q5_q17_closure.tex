...
whose smallest prime divisor is smaller; after the five closures proved here,
such a case would lie in the remaining branch \(q=3\).  In each of the five
branches, every case generated from the exact \(q\)-adic valuation balance for
...
\cite{OchemRao2012}.  Writing \(p_1<p_2<\cdots<p_k\) for the distinct prime
divisors of a hypothetical odd perfect number, Goto--Ohno
