...
The present paper uses these results only as branch filters and consistency
checks; the actual branch closures below are driven by valuation-labeled
cyclotomic input and finite certificates.
