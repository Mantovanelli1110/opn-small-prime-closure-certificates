...
\title{Every Odd Perfect Number Must Be Divisible by 3}
\author{
Marco Mantovanelli\\
...
\(\omega(N)\ge 9\), already implies \(q<8\); hence the remaining possible
minimal-prime branches are \(q=3,5,7\).  This paper gives
certificate-based closures for the minimal-prime branches \(q=5\) and \(q=7\).
These are least-prime-divisor assertions: they do not
...
I thank Beno\^{\i}t Clo\^{\i}tre for the very helpful feedback on an earlier
draft of this paper.
